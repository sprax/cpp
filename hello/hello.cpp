...
//      clang++ hello.cpp -o hello.out && hello.out  [you might need
//      ./hello.out]
...
//      clang -lstdc++ hello.cpp -o hello.out && hello.out (Use libstdc++ for
//      compatibility with libMLi3)
...
int main(int argc, char *argv[]) {
  ...
  cout << "This is " << argv[0] << ", just saying Hello, " << name << "."
       << endl;
  return 0;
}
